...
class StereoBM(BlockMatcher):
    ...
    parameter_maxima = {"search_range": None,
                       "window_size": 255,
                       "stereo_bm_preset": cv2.STEREO_BM_PREFILTER_NORMALIZED_RESPONSE}
    ...
    def stereo_bm_preset(self, value):
        ...
        if value in (#cv2.STEREO_BM_BASIC,
                     #cv2.STEREO_BM_FISH_EYE,
    ...
    #def __init__(self, stereo_bm_preset=cv2.STEREO_BM_BASIC,
