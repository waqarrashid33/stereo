    ...
    while index<=num_pictures:
        ...
        if cv2.waitKey(1) & 0xFF == ord(key):
            ...
            try:
                ...
                cv2.imwrite('images/right_{}.ppm'.format(str(index).zfill(len(str(num_pictures)))),left)
                cv2.imwrite('images/left_{}.ppm'.format(str(index).zfill(len(str(num_pictures)))),right)
