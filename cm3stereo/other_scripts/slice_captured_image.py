...
cv2.imwrite("~/workspace/git/cm3stereo/calib_rect/test_images/left_01.jpg", left)
cv2.imwrite("~/workspace/git/cm3stereo/calib_rect/test_images/right_01.jpg", right)
